...
set path=C:\Program Files (x86)\FreeBASIC107;C:\Program Files (x86)\FreeBASIC107\bin\win32;%PATH%
 ...
 as.exe -I"C:\Users\Gamer\Desktop\FB_CIN_VIWER\FB_Quake2\FB_Ref_Soft"  -v -alsm="FB_Ref_Soft\r_aclipa.lst"  -o "FB_Ref_Soft\FQ_R_aclipa.o"   "FB_Ref_Soft\FQ_R_aclipa.asm"
